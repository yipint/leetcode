...
// 
// 
// Related Topics 树 深度优先搜索 二叉树 字符串匹配 哈希函数 👍 902 👎 0
...
class Solution_572 {
    ...
    public static boolean isSame(TreeNode current, TreeNode subRoot) {
        ...
        return isSame(current.left, subRoot.left) && isSame(current.right, subRoot.right);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("" + isSubtree(root, subTree));
    }
}
